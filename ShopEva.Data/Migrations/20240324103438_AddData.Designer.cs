...
namespace ShopEva.Data.Migrations
{
    ...
    [Migration("20240324103438_AddData")]
            ...
            modelBuilder.Entity("ShopEva.Models.Model.Sys_Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 24, 10, 34, 37, 934, DateTimeKind.Utc).AddTicks(6495),
                            Name = "Nháp",
                            Status = 0,
                            Status_Of = 0
                        },
                        new
                        {
                            ID = 1,
                            CreatedBy = new Guid("8e1dce0d-5997-4834-b8ac-cbd4614e2b78"),
                            CreatedDate = new DateTime(2024, 3, 24, 10, 34, 37, 934, DateTimeKind.Utc).AddTicks(6508),
                            Name = "Sử dụng",
                            Status = 0,
                            Status_Of = 0
                        },
                        new
                        {
                            ID = 2,
                            CreatedBy = new Guid("8e1dce0d-5997-4834-b8ac-cbd4614e2b78"),
                            CreatedDate = new DateTime(2024, 3, 24, 10, 34, 37, 934, DateTimeKind.Utc).AddTicks(6510),
                            Name = "Không sử dụng",
                            Status = 0,
                            Status_Of = 0
                        },
                        new
                        {
                            ID = 15,
                            CreatedBy = new Guid("8e1dce0d-5997-4834-b8ac-cbd4614e2b78"),
                            CreatedDate = new DateTime(2024, 3, 24, 10, 34, 37, 934, DateTimeKind.Utc).AddTicks(6512),
                            Name = "Chờ duyệt",
                            Status = 0,
                            Status_Of = 0
                        });
